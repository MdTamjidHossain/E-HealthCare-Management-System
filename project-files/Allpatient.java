...
public class Allpatient extends JFrame implements ActionListener{
    ...
    public void initComponents() {
        this.setTitle("View All Patients");
        ...
        allpatientLabel.setText("View All Patient");
    ...
    public static void main(String[] args) {
        Allpatient patient = new Allpatient();
