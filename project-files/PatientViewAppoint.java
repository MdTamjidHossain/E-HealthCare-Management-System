...
public class PatientViewAppoint extends JFrame implements ActionListener {
    ...
    public PatientViewAppoint() {
        initComponents();
    }

    public void initComponents() {
        this.setTitle("View Your Appointments");
        ...
        doctoridLabel.setText("Enter Your Patient ID:");
        ...
        doctorauthLabel.setText("Enter Your Patient Authcode:");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == backButton) {
            ...
            try {
                ...
                String sql = "select * from patient where id = '" + doctoridField.getText() + "' and authcode='" + doctorauthField.getText() + "'";
                ...
                if (doctoridField.getText().equals(id) && doctorauthField.getText().equals(auth)) {
                    ...
                    try {
                        ...
                        String query = "select * from appointment where patient_id='" + doctoridField.getText() + "'";
