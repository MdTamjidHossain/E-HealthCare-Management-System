...
public class PatientViewDoctor extends JFrame implements ActionListener{
    ...
    private String[] columns = {"ID", "Name", "Specialist", "Adress", "Mobile Number", "Email"};
    private String[] rows = new String[6];
    private Connection con=null;
    private Statement st=null;

    public PatientViewDoctor() {
        initComponents();
    }
    ...
    public void initComponents() {
        ...
        allpatientLabel.setText("View All Doctors");
    ...
    public static void main(String[] args) {
        PatientViewDoctor doctor = new PatientViewDoctor();
